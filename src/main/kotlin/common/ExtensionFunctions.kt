...
fun String.convertCyrillic(): String {
    ...
    val cyr = arrayOf(
        ...
        "р", "с", "т", "у", "ф", "х", "ц", "ч", "ю", "я", "э", "ш", "щ", "ь", "А", "Б", "В", "Г", "Д", "Е", "Ё", "Ж", "З",
        "И", "К", "Л", "М", "Н", "О", "П", "Р", "С", "Т", "У", "Ф", "Х", "Ц", "Ч", "Ю", "Я", "Э", "Ш", "Щ"
    )
    val lat = arrayOf(
        "a", "b", "v", "g", "d", "e", "e", "zh", "z", "i", "y", "k", "l", "m", "n", "o", "p",
        "r", "s", "t", "u", "f", "h", "ts", "ch", "yu", "ya", "eh", "sh", "shch", "", "A", "B", "V", "G", "D", "E", "E", "Zh", "Z",
        "I", "K", "L", "M", "N", "O", "P", "R", "S", "T", "U", "F", "H", "Ts", "Ch", "Yu", "Ya", "Eh", "Sh", "Shch"
    )
